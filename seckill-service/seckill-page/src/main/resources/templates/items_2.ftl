...
<header>
    ...
    <div class="swiper-container">
        <div class="swiper-wrapper">
            <#if images??>
                <div class="swiper-slide"><img src="${images[0]}" :onerror="defaultImage" width="100%"></img></div>
            <#else>
                <div class="swiper-slide"><img src="https://img11.360buyimg.com/n7/jfs/t1/101646/6/13621/393111/5e5d1390E7ea13607/0117bb13ca414b11.jpg" :onerror="defaultImage" width="100%"></img></div>
            </#if>
        </div>
        <!-- 如果需要分页器 -->
    ...
    <div class="detailsInfo">
        ...
        <div style="padding-top: 15px;padding-right: 15px;">
            <div v-if="isbegin==1" id="time" class="time">距离结束：<span>{{hours}}</span> ：<span>{{minutes}}</span> ：<span>{{seconds}}</span> </div>
            <div v-if="isbegin==0" id="time" class="time">距离开始：<span>{{hours}}</span> ：<span>{{minutes}}</span> ：<span>{{seconds}}</span> </div>
            <div v-if="isbegin==-1" id="time" class="time">活动已结束</div>
        </div>
    </div>
</header>
